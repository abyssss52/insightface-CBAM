...
dataset.ms1m_05822x_all = edict()
dataset.ms1m_05822x_all.dataset = 'ms1m_05822x_all'
dataset.ms1m_05822x_all.dataset_path = '../datasets/ms1m_05822x_all'
dataset.ms1m_05822x_all.num_classes = 346
